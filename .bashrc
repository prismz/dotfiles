...
# TODO: https://unix.stackexchange.com/questions/8396/bash-display-exit-status-in-prompt
#
if [ "$(whoami)" == "root" ]; then
        # export PS1='[$(echo -ne ret "$?" in \e[34m\]$(prettytime ${timer_show}))] \[\e[38;5;196m\]\u\[\e[0m\] in \[\e[94m\]\w\[\e[38;5;93m\] λ \[\e[0m\]'
        export PS1='[$(echo -ne \[\e[34m\]$(prettytime ${timer_show}))] \[\e[38;5;196m\]\u\[\e[0m\] in \[\e[94m\]\w\[\e[38;5;93m\] λ \[\e[0m\]'
else
        # export PS1='[$(echo -ne ret "$?" in \e[34m\]$(prettytime ${timer_show}))\[\e[m\]] \[\e[92m\]\u\[\e[0m\] in \[\e[94m\]\w\[\e[38;5;93m\] λ \[\e[0m\]'
        export PS1='[$(echo -ne \[\e[34m\]$(prettytime ${timer_show}))\[\e[m\]] \[\e[92m\]\u\[\e[0m\] in \[\e[94m\]\w\[\e[38;5;93m\] λ \[\e[0m\]'
fi

set -o vi                                  # hit esc for vi mode
#set vi-ins-mode-string (ins)
#set vi-cmd-mode-string (cmd)
bind -m vi-insert "\C-l":clear-screen      # enable Ctrl+L in vi insert mode
...
# black background
# echo -ne '\e]11;rgb:0/0/0\a'

PATH=$PATH:/$HOME/.local/bin

# aliases
[ -f "/home/hasan/.bash_aliases" ] && source /home/hasan/.bash_aliases
...
# KDE file picker
# remember to delete from /etc/profile as well if you remove this!
...
export PAN_MESA_DEBUG="gofaster:gofaster"

#export PATH=$PATH:/home/hasan/.millennium/ext/bin

# Eternal bash history.
# found at https://superuser.com/questions/137438/how-to-unlimited-bash-shell-history
# ---------------------
